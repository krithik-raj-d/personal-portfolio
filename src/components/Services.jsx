...
const Services = () => {
  return (
    <div className="bg-[url(/service-bg.jpg)] bg-no-repeat bg-cover w-full h-screen flex flex-col md:flex-row md:justify-between items-center p-5 md:p-20">
      {/*  */}
      <div className=" outline-1 outline-white/30 outline-offset-4 bg-white/10 backdrop-blur-xs p-5 rounded-lg flex flex-col items-center gap-5">
        ...
        <BlurText
          text="I offer a comprehensive suite of services designed to bring your
          digital vision to life."
          delay={200}
          animateBy="words"
          direction="top"
